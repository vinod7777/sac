...
export const events = [
  {
    ...
    slug: "salesforce-administrator-level-1",
    dates: "2025-09-15 to 2025-09-20",
    mode: "Offline",
    price: "Free",
    club: "Salesforce Club",
    location: "SAC Lab 2, AITAM Campus",
    time: "09:00 AM - 04:00 PM",
    organizer: "AITAM Student Activity Center & Salesforce Admin Group Srikakulam",
    about: "An intensive 6-day hands-on bootcamp designed to prepare students for the Salesforce Certified Administrator exam. Participants will gain practical experience in configuring Salesforce applications, managing users, defining security & access controls, and building custom reports & dashboards.",
    highlights: [
      "Official Trailhead Superbadge guidance",
      "Hands-on org configuration and data management labs",
      "Mock certification exams & study vouchers",
      "Direct interaction with Salesforce Certified Professionals",
    ],
    prerequisites: "Basic knowledge of databases and web applications. Open to all branches.",
    mentor: "S. Lahari Chowdary",
    mentorRole: "Mentor — Salesforce",
    color: "var(--club-orange)",
    icon: "Cloud",
  },
  {
    ...
    slug: "arduino-sensors-programming-foundations",
    dates: "2025-08-11 to 2025-08-16",
    mode: "Offline",
    price: "Free",
    club: "Robotics Club",
    location: "Robotics & IoT Innovation Hub, AITAM",
    time: "10:00 AM - 04:30 PM",
    organizer: "AITAM SAC Robotics Club",
    about: "A practical 1-week workshop focusing on hardware fundamentals, sensor interfacing, and micro-controller C/C++ programming. Students will work with ultrasonic, infrared, and temperature sensors to build real automation prototypes.",
    highlights: [
      "Individual hardware component kits provided",
      "Breadboard circuit prototyping & debugging",
      "Real-time sensor data logging & actuation",
      "Team project presentation on Day 6",
    ],
    prerequisites: "Basic C programming knowledge recommended.",
    mentor: "B. Sandeep",
    mentorRole: "Mentor — Robotics & IoT",
    color: "var(--club-crimson)",
    icon: "Bot",
  },
  {
    ...
    organizer: "AITAM SAC Developers Club",
    about: "Learn modern full-stack web development from scratch using React, Node.js, Express, and Tailwind CSS. Shipped products at the end of the workshop will be hosted live on cloud platforms.",
    highlights: [
      "Building RESTful APIs with Node & Express",
      "Modern UI component design with React & Tailwind CSS",
      "Git & GitHub workflow best practices",
      "Live deployment to Vercel and Cloudflare",
    ],
    prerequisites: "HTML/CSS and JavaScript basics.",
    mentor: "Saisateeshwara Reddy",
    mentorRole: "Mentor — Web & App Development",
    color: "var(--club-teal)",
    icon: "Code2",
  },
  {
    title: "Ethical Hacking & Cyber Security Workshop",
    slug: "ethical-hacking-cyber-security-workshop",
    dates: "2025-10-05 to 2025-10-10",
    mode: "Offline",
    price: "Free",
    club: "Security Club",
    location: "Cyber Security Lab, AITAM",
    time: "10:00 AM - 04:00 PM",
    organizer: "AITAM SAC Security Club",
    about: "Dive deep into web vulnerability assessment, penetration testing, Kali Linux tools, and network defense strategies. Learn ethical hacking techniques to protect digital assets against cyber threats.",
    highlights: [
      "Hands-on CTF (Capture The Flag) competitions",
